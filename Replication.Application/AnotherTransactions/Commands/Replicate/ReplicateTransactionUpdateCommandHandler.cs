...
internal sealed class AddTransactionUpdateCommandHandler : ICommandHandler<ReplicateAnotherTransactionUpdateCommand>
{
    private readonly AnotherTransactionReplicationService _anotherTransactionReplicationService;
    private readonly IBus _bus;
    private readonly IUnitOfWork _unitOfWork;

    public AddTransactionUpdateCommandHandler(
        IBus bus,
    ...
    public async Task<Result> Handle(ReplicateAnotherTransactionUpdateCommand request, CancellationToken cancellationToken)
    {

        Result<AnotherTransactionReplication> anotherTransactionReplicatiomResult = 
            await _anotherTransactionReplicationService.ReplicateAnotherTransactionUpdateAsync(request.transactionId, request.transactionData);
